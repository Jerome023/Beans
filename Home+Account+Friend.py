...
while running:
    ...
    if current_screen == "home":
        ...
        # Nav bar
        buttons += [
            Button("Plants", 30, HEIGHT-50, 120, 40, lambda: None),   # Left button
    ...
    # --- Other screens unchanged ---
        ...
        buttons = [Button("Add Friend", 65, 370, 230, 40, go_add_friend),
                   ...
                   Button("Plants", 30, HEIGHT-50, 120, 40, lambda: None),
    ...
    for e in pygame.event.get():
        ...
        # Login/Register/Friends event handlers
